...
class SCSelectHouseUnitSearchStaticView extends StatelessWidget {

  const SCSelectHouseUnitSearchStaticView({Key? key}) : super(key: key);
  ...
  Widget body() {
    return GestureDetector(
      ...
      onTap: () {
        SCSelectHouseUnitSearchStatusController searchState = Get.find<SCSelectHouseUnitSearchStatusController>();
