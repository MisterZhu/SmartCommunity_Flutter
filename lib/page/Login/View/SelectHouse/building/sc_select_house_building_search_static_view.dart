...
class SCSelectHouseBuildingSearchStaticView extends StatelessWidget {

  const SCSelectHouseBuildingSearchStaticView({Key? key}) : super(key: key);
  ...
  Widget body() {
    return GestureDetector(
      ...
      onTap: () {
        SCSelectHouseBuildingSearchStatusController searchState = Get.find<SCSelectHouseBuildingSearchStatusController>();
