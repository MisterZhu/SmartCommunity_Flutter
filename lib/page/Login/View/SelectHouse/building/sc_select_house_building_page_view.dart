...
import 'package:smartcommunity/page/Login/View/SelectHouse/building/sc_select_house_building_listview.dart';
import 'package:smartcommunity/page/Login/View/SelectHouse/building/sc_select_house_building_search_dynamic_view.dart';
...
class _SCSelectHouseBuildingPageViewState
  ...
  Widget searchHeader() {
    return GetBuilder<SCSelectHouseBuildingSearchStatusController>(builder: (state) {
      if (state.isShowCancel) {
        // 搜索中……
        return SCHouseBuildingSearchDynamicView(
