...
class SCHomeController1 extends GetxController {
  ...
  updateHomeData() {
    ...
    String questionnaire = "${SCConfig.getH5Url(SCH5.questionnaire)}?Authorization=$token&client=${SCDefaultValue.client}&userId=$userId&userName=$userName&phoneNum=$phoneNum&city=${Uri.encodeComponent(city)}&latitude=$latitude&longitude=$longitude&gender=$gender&defCommunityId=$defCommunityId";
    ...
    allItemsList = [
      ...
      {"iconUrl": SCAsset.iconItem12, "title": "调查问卷", "subUrl": questionnaire, "needHouseId": true, 'isDeveloping': true},
