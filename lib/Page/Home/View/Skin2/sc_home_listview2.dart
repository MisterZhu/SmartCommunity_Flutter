  ...
  itemDetail(int index) {
    if (SCScaffoldManager.instance.isLogin) {
      ...
      if (needHouseId && SCScaffoldManager.instance.user.communityId == null) {
        ...
        var params = {"title": title, "url": "http://172.16.191.89:8081/h5Manage/#/meterReadingTask/meterReadingTaskList?spaceIds=120260068&orgIdList=&Authorization=eyJhbGciOiJFUzI1NiJ9..w80up5Y-dHKWbl947bluAAzqONMGy7IHr5n3Rqg5swFeyB0_NttcVJ8j35q_KN657YIO-6fqRKFTWQ31ZDBsgg&userId=129036370972109&userName=杨洁&client=co-wecom&defOrgId=eb1e1ad8-85af-42d0-ba3c-21229be19009&defOrgName=海滨租户&fromQw=1&tenantId=eb1e1ad8-85af-42d0-ba3c-21229be19009&phoneNum=18011623935&appId=wxb9a6e4e0bc429469"};
